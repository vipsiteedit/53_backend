        ...
        <div class="records-container">
            <repeat:records>
                <div class="object record-item" [objedit]>[*edobj]
                    <a href=<if:record.field!=''>"[record.field]"<else>"#"</if> class=<if:record.field==[thispage.name]>"link linkActive record-field"<else>"link record-field"</if>>
                        <[record.title_tag]>[record.title]</[record.title_tag]>
                    </a>
                   <noempty:record.image>
                        <a class="record-image-link" href=<if:record.field!=''>"[record.field]"<else>"#"</if>>
                            <img class="objectImage record-pimage" src="[record.image_prev]" border="0" alt="[record.image_alt]">
                        </a>
                    </noempty>
                    <noempty:record.note>

...
<?php if(strval($section->parametrs->param2)=='Y'): ?>
    <script src="http://api-maps.yandex.ru/2.1/?load=package.standard&lang=ru-RU&apikey=<?php echo $section->parametrs->param3 ?>" type="text/javascript"></script>
<?php endif; ?>
</footer:js>
<div class="content contShopContacts" data-type="<?php echo $section->type ?>" data-id="<?php echo $section->id ?>" >

<?php
function module_header_start30($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/header_start30';
 else $__MDL_URL = 'modules/header_start30';
 $__MDL_ROOT = dirname(__FILE__).'/header_start30';

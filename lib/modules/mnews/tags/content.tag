                    ...
                    <noempty:record.image>
                        <if:[param9]=='N'><noindex></if>
                            <a href="[record.link_detail]" class="record-image-link" <if:[param9]=='N'>rel="nofollow"</if> >
                                <img class="objectImage record-pimage" src="[record.image_prev]" border="0" alt="[record.image_alt]" title="[record.image_alt]">
                            </a>
                        <if:[param9]=='N'></noindex></if>
                    </noempty>
                    <noempty:record.note>
                ...
                <div id="view">
                    ...
                    <noempty:record.image>
                        <div class="objimage record-image">
                            <img class="objectImage" alt="[record.image_alt]" title="[record.image_alt]" src="[record.image]" border="0">
                        </div>
                    </noempty>
                    <if:[param5]=='Y'>
                        <noempty:record.note>

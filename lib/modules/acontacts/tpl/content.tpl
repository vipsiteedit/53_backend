...
<footer:js>
    <script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&apikey=<?php echo $section->parametrs->param16 ?>" type="text/javascript"></script>
...
<div class="content contacts" >
  <div class="vcard">
     ...
     <div class="addr-block">
       <div class="name">
         <span class="orgtitle"><?php echo $section->language->lang007 ?></span>
         <span class="fn org"><?php echo $section->parametrs->param6 ?></span>
       </div>
       <div class="phone">
         <span class="orgtitle"><?php echo $section->language->lang008 ?></span>
         <span class="tel"><?php echo $section->parametrs->param7 ?></span>
       </div>
       <div class="adr">

<?php
function module_anavcatalog_top($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/anavcatalog_top';
 else $__MDL_URL = 'modules/anavcatalog_top';
 $__MDL_ROOT = dirname(__FILE__).'/anavcatalog_top';

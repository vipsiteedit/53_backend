<?php
function module_ashop_cart_compl($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/ashop_cart_compl';
 else $__MDL_URL = 'modules/ashop_cart_compl';
 $__MDL_ROOT = dirname(__FILE__).'/ashop_cart_compl';
 ...
 if ($ajax){ 
     ...
     if ($total['count'] > 0 && (isRequest('delcartname') || isRequest('countitem') || isRequest('delivery_type_id') || isRequest('set_region') || isRequest('getcart')|| isset($upd_delivery))){
         ob_start();

<?php
function module_navtop_start($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/navtop_start';
 else $__MDL_URL = 'modules/navtop_start';
 $__MDL_ROOT = dirname(__FILE__).'/navtop_start';

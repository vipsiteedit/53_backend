...
function module_mforum($razdel, $section = null)
{
 ...
 unset($tbl);
 se_db_query("DELETE FROM forum_session WHERE `date_time`<'$date_time' OR `sid`='{$sid}'");
 $date_time = time();
 ...
 && $__data->req->sub=='14' && file_exists($__MDL_ROOT . "/tpl/subpage_14.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_14");
 ...
 && $__data->req->sub=='15' && file_exists($__MDL_ROOT . "/tpl/subpage_15.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_15");
 ...
 && $__data->req->sub=='16' && file_exists($__MDL_ROOT . "/tpl/subpage_16.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_16");
 ...
 && $__data->req->sub=='17' && file_exists($__MDL_ROOT . "/tpl/subpage_17.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_17");
 ...
 && $__data->req->sub=='18' && file_exists($__MDL_ROOT . "/tpl/subpage_18.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_18");
 ...
 && $__data->req->sub=='19' && file_exists($__MDL_ROOT . "/tpl/subpage_19.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_19");
 ...
 && $__data->req->sub=='20' && file_exists($__MDL_ROOT . "/tpl/subpage_20.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_20");
 ...
 && $__data->req->sub=='21' && file_exists($__MDL_ROOT . "/tpl/subpage_21.tpl")){
	...
	ob_start();
	include $__data->include_tpl($section, "subpage_21");

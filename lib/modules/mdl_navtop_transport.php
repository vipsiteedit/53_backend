<?php
function module_navtop_transport($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/navtop_transport';
 else $__MDL_URL = 'modules/navtop_transport';
 $__MDL_ROOT = dirname(__FILE__).'/navtop_transport';

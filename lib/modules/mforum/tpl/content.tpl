<div class="content forum" <?php echo $section->style ?>>
    <?php if(file_exists($__MDL_ROOT."/php/subpage_19.php")) include $__MDL_ROOT."/php/subpage_19.php"; if(file_exists($__MDL_ROOT."/tpl/subpage_19.tpl")) include $__data->include_tpl($section, "subpage_19"); ?>
    <?php if($enable==1): ?>
    ...
    <?php else: ?>
        ...
        <?php else: ?>
            <?php if(file_exists($__MDL_ROOT."/php/subpage_21.php")) include $__MDL_ROOT."/php/subpage_21.php"; if(file_exists($__MDL_ROOT."/tpl/subpage_21.tpl")) include $__data->include_tpl($section, "subpage_21"); ?>
            <!--Начало тела страницы-->
            <h3 class='forumTitle' id='forumtitle'><?php echo $nameForum ?></h3>
            <table class='tableForum' id='table_main' border=0>
                <tbody class='tableBody'>
                    <tr>
                        <td <?php if(strval($section->parametrs->param98)!=2): ?>colspan=2<?php endif; ?> class='title' id='title_MainForum'>
                    ...
                    <?php foreach($section->forums as $forum): ?>
                        ...
                        <?php endif; ?>
                        <tr>
                            <?php if(strval($section->parametrs->param98)!=2): ?>
...
<?php endforeach; ?>)
        ...
        <?php endif; ?>
    <?php endif; ?>
    <?php if(file_exists($__MDL_ROOT."/php/subpage_20.php")) include $__MDL_ROOT."/php/subpage_20.php"; if(file_exists($__MDL_ROOT."/tpl/subpage_20.tpl")) include $__data->include_tpl($section, "subpage_20"); ?>
</div>

...
<section class="content b_brendline part<?php echo $section->id ?>" >
      ...
      <?php foreach($section->items as $item): ?>
        <div class="b_brendline-brend_item" <?php echo $__data->editItemRecord($section->id, $record->id) ?>>
          <?php if(!empty($item->picture)): ?>
            <a class="objectImage" href="<?php echo $item->url ?>">
                <img class="b_brendline-brend_img" border="0" src="<?php echo $item->picture ?>" border="0" alt="<?php echo $item->picture_alt ?>" style="width: 100%">
            </a>
          <?php endif; ?>
        </div>
    ...
    <ul>
         ...
         <li>
          <div class="jcarousel-inner">
           <a  href="<?php echo $item->url ?>" class="jcarousel-image-container">
            <img src="<?php echo $item->picture ?>" alt="<?php echo $item->picture_alt ?>"> 
           </a>                           
          </div>
         </li>
                        <?php endif; ?>

<?php
function module_header_transport($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/header_transport';
 else $__MDL_URL = 'modules/header_transport';
 $__MDL_ROOT = dirname(__FILE__).'/header_transport';

            ...
            <div class="goodsDetPriceBox" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                <form class="form_addCart" method="post" action="">
                    ...
                    <div class="goodsButton form-group">
                        ...
                        <?php endif; ?>
                        <?php if(strval($section->parametrs->param347)=='Y'): ?><span class="add_wish<?php if($user_wish): ?> active<?php endif; ?>" data-id="<?php echo $product_id ?>" title="<?php echo $section->language->lang126 ?>" data-wish="<?php echo $user_wish ?>"></span><?php endif; ?>
                    </div>
                </form>
            </div>
            </div>

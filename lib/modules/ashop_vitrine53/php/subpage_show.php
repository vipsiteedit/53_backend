...
$availability = ($plugin_amount->getPresenceCount()==0) ? 'OutOfStock' : 'InStock';
...
$product_name = $shop_variables->parseProductText($price_fields['page_title'], $price_fields);
...
$user_wish = $psg->getGoodsWish($user_id, $product_id); 

...
<SE>
        ...
        <div class="form_mail">
            ...
            <if:[param13]!='No'>
                <div class="field_pin">
                    <label class="field_title">[lang016]</label>
                    <div class="field_imgtxt">
                        <se><img class="captcha_img" style="width:150px; height:30px" src="[system.path]cardimage.gif"></se>[$captcha] 
                        <input maxlength="5" size="5" name="pin" type="text" class="field_txtpin" title="[lang016]" autocomplete="off">
                    </div>
                </div>
            </if>

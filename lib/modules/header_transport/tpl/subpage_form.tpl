<form id="Go" action="" method="post">
        ...
        <div class="form_mail">
            ...
            <?php if(strval($section->parametrs->param13)!='No'): ?>
                <div class="field_pin">
                    <label class="field_title"><?php echo $section->language->lang016 ?></label>
                    <div class="field_imgtxt">
                        <?php echo $captcha ?> 
                        <input maxlength="5" size="5" name="pin" type="text" class="field_txtpin" title="<?php echo $section->language->lang016 ?>" autocomplete="off">
                    </div>
                </div>
            <?php endif; ?>

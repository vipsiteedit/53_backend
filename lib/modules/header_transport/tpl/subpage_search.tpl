...
<form method="get" action="<?php echo seMultiDir()."/".$section->parametrs->param1."/" ?>" style="margin: 0;">
        <input type="text" class="livesearch" name="q" value="" placeholder="<?php echo $section->language->lang001 ?>" autocomplete="off">

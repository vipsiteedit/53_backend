<?php
function module_mshop_cart53($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/mshop_cart53';
 else $__MDL_URL = 'modules/mshop_cart53';
 $__MDL_ROOT = dirname(__FILE__).'/mshop_cart53';

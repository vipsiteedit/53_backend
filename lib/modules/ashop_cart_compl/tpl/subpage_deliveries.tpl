<?php foreach($section->deliverylist as $delivery): ?>
    <div class="deliveryType" data-id="<?php echo $delivery->id ?>"> 
        <label title="<?php echo $section->language->lang030 ?>">
            <input class="radioDeliveryType js_radio" type="radio" name="delivery_type_id" value="<?php echo $delivery->id ?>"<?php echo $delivery->sel ?> data-addr="<?php echo $delivery->addr ?>">
            <span class="stylize_radio"></span>

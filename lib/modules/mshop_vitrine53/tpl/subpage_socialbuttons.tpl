<script src="/lib/js/social/social-likes.min.js"></script>
<?php if($section->parametrs->param312 == '01'): ?>
<link rel="stylesheet" type="text/css" href="/lib/js/social/social-likes_birman.css">
<?php endif; ?>
<?php if($section->parametrs->param312 == '02'): ?>
<link rel="stylesheet" type="text/css" href="/lib/js/social/social-likes_flat.css">
<?php endif; ?>
<?php if($section->parametrs->param312 == '03'): ?>
<link rel="stylesheet" type="text/css" href="/lib/js/social/social-likes_classic.css">
<?php endif; ?>

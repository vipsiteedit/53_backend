    ...
    <div class="specialItem" style="position:relative;">
        ...
        <div class="specialButton">
            <form class="form_addCart" style="margin:0px;" method="post" action="">
                ...
                <?php endif; ?>
                <button class="buttonSend addcart" title="<?php echo $section->language->lang022 ?>" <?php if(empty($record->maxcount)): ?><?php if($section->parametrs->param233=='Y'): ?>disabled<?php else: ?>style="display:none;"<?php endif; ?><?php endif; ?>><?php echo $section->language->lang033 ?></button>

...
<?php if($section->parametrs->param282=='Y'): ?> 
...
<?php endif; ?>
<div class="content e_shopvit<?php if(!empty($quickview)): ?> quickShow<?php endif; ?>" > 
    <div id="product" class="goodsContentDet <?php if($section->parametrs->param85=='Y'): ?>notAjaxCart<?php endif; ?>">
        <?php if(empty($quickview)): ?>
        <?php if($section->parametrs->param246!='N'): ?>
...
<?php endforeach; ?>
                <?php if($section->parametrs->param246=='A'): ?>
        ...
        <div class="goodsDetail col-lg-12 col-md-12 col-sm-12 col-xs-12" itemscope itemtype="http://schema.org/Product">
            <?php if($section->parametrs->param329!='N' || $quickview!=''): ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="goodsLinkPhoto">
                    <a href="<?php echo $img_full ?>" title="<?php echo $price_img_alt ?>"  target="_blank">
                        <img class="goodsPhoto img-responsive center-block" src="<?php echo $img_mid ?>" style="" alt="<?php echo $price_img_alt ?>" data-large="<?php echo $img_full ?>" itemprop="image">
                    </a>
                </div>
                <?php if($section->parametrs->param320!='N'): ?>
...
<?php endforeach; ?>
            ...
            <?php if($section->parametrs->param133!='N' && $product_note!=''): ?>
            ...
            <?php endif; ?>
            <?php if($section->parametrs->param126=='Y' && $product_code!=''): ?>
            ...
            <?php endif; ?>
            <?php if($section->parametrs->param129=='Y' && $product_brand!=''): ?>
            ...
            <?php endif; ?> 
            <?php if($section->parametrs->param334=='Y'): ?>
            ...
            <div class="goodsDetPriceBox" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                <div class="goodsPrice<?php if(empty($realprice)): ?> nullPrice<?php endif; ?>">
                    ...
                    <span class="priceValue">
                        <?php if($section->parametrs->param113=='Y' && $product_oldprice!=''): ?>
                ...
                <form class="form_addCart" method="post" action="">
                    <?php if($section->parametrs->param138=='Y'): ?>
                    ...
                    <div class="goodsButton form-group">
                        ...
                        <?php if(empty($maxcnts)): ?>
                            <input type="hidden" name="notavailable" value="<?php echo $product_id ?>">
                        <?php endif; ?>
                        <button class="buttonSend addcart btn btn-default" title="<?php echo $section->language->lang022 ?>" <?php if(empty($maxcnts)): ?><?php if($section->parametrs->param233=='Y'): ?>disabled<?php else: ?>style="display:none;"<?php endif; ?><?php endif; ?>><?php echo $section->language->lang033 ?></button>
                        <?php if($quickview==''): ?>
            ...
            <?php if($section->parametrs->param312!='N'): ?>
            ...
            <?php endif; ?>
            <?php if(empty($quickview)): ?>
                <?php if($section->parametrs->param258=='Y'): ?>
                ...
                <?php endif; ?>
                <?php if($section->parametrs->param306!='N'): ?> 
                ...
                <?php endif; ?> 
                <?php if($section->parametrs->param314!='N'): ?> 
            ...
            <?php if(empty($quickview)): ?>
                <?php if($section->parametrs->param316!='N'): ?>
                ...
                <?php endif; ?>
                <?php if($section->parametrs->param317!='N'): ?>

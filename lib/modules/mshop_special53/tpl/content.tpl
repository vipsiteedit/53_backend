...
<script type="text/javascript" src="[module_url]mshop_special53.js"></script>
<script type="text/javascript"> mshop_special53_execute({id:<?php echo $section->id ?>, p32:'<?php echo $section->parametrs->param32 ?>',p46:'<?php echo $section->parametrs->param46 ?>'});</script>

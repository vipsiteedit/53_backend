<?php
 ...
 if (!isset($section->parametrs->param6)) $section->parametrs->param6 = "руб";
 if (!isset($section->parametrs->param10)) $section->parametrs->param10 = "1.00";
 ...
 if (!isset($section->parametrs->param7)) $section->parametrs->param7 = "Код";
 ...
 if (!isset($section->parametrs->param3)) $section->parametrs->param3 = "Заказать";

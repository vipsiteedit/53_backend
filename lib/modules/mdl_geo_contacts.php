<?php
function module_geo_contacts($razdel, $section = null)
{
 ...
 if (strpos(dirname(__FILE__),'/lib/modules'))
   $__MDL_URL = 'lib/modules/geo_contacts';
 else $__MDL_URL = 'modules/geo_contacts';
 $__MDL_ROOT = dirname(__FILE__).'/geo_contacts';

...
<?php foreach($__data->limitObjects($section, $section->objectcount) as $record): ?>
        ...
        <?php if($section->parametrs->param1=='N'): ?><tr><?php endif; ?><td class="tab  <?php if($obj==0): ?><?php if("$record->id"=="$__record_first"): ?> active<?php endif; ?><?php else: ?><?php if($record->id==$obj): ?>active 2<?php endif; ?><?php endif; ?> ">

...
<div class="content shop_wishlist" data-type="<?php echo $section->type ?>" data-id="<?php echo $section->id ?>" <?php echo $section->style ?>>
...
<?php endforeach; ?>
    ...
    <form name="formWishList" method="post" action="">
    <button type="submit" name="clear_wishlist" class="btn btn-danger button_clear_wishlist"><?php echo $section->language->lang120 ?></button>
    </form>
   </div>    
        <?php else: ?>

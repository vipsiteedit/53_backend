        ...
        <div class="blockAddCart col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <form class="form_addCart" method="post" action="">    
                ...
                <?php if($record->maxcount==0 && strval($section->parametrs->param336)=='Y'): ?>
                    <button type="button" class="buttonSend btnPreorder btn btn-default"><?php echo $section->language->lang117 ?></button>
                <?php endif; ?>
                ...
                <button class="buttonSend btnDelProd btn btn-default btn-danger" title="<?php echo $section->language->lang119 ?>" data-id="<?php echo $record->id ?>"><i class="glyphicon glyphicon-trash"></i> <?php echo $section->language->lang118 ?></button>

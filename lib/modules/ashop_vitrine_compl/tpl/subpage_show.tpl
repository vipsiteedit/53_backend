...
<div class="content ashopvit_compl<?php if(!empty($quickview)): ?> quickShow<?php endif; ?>" data-type="<?php echo $section->type ?>" data-id="<?php echo $section->id ?>" >
    <div id="product" class="goodsContentDet <?php if(strval($section->parametrs->param85)=='Y'): ?>notAjaxCart<?php endif; ?>">
        ...
        <?php if(strval($section->parametrs->param246)!='N'): ?>
            <ol class="goodsPath breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <a class="goodsPathRoot" href="/" itemprop="item"><span itemprop="name"><?php echo $section->language->lang132 ?></span></a>
                    <meta itemprop="position" content="1">
                </li>
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <a class="goodsPathRoot" href="<?php echo seMultiDir()."/".$_page."/" ?>" itemprop="item"><span itemprop="name"><?php echo $section->language->lang019 ?></span></a>
                    <meta itemprop="position" content="2">
                </li>
                <?php foreach($section->pathg as $pth): ?>
                    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <a class="goodsLinkPath" href="<?php echo seMultiDir()."/".$_page."/" ?>cat/<?php echo $pth->cat ?>/" itemprop="item"><span itemprop="name"><?php echo $pth->cat_nm ?></span></a>
                        <meta itemprop="position" content="<?php echo $pth->pos ?>"> 
                    </li>

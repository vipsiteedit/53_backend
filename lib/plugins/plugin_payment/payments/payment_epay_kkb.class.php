...
class payment_epay_kkb extends basePayment
{
    ...
    public function blank($pagename)
    {
        ...
        $url = (!$this->test) ? 'https://epay.kkb.kz/jsp/process/logon.jsp' : 'https://testpay.kkb.kz/jsp/process/logon.jsp'; //https://3dsecure.kkb.kz/jsp/process/logon.jsp
        $currency_id = '398';
    ...
    public function result()
    {
        ...
        $post = $_POST;
        if (SANDBOX == true) {
            $this->logs("POST: ".print_r($_POST,1)."");
            $this->logs("GET: ".print_r($_GET,1)."");
        }
        ...
        if (is_array($result)) {
            ...
            if (in_array("DOCUMENT",$result)) {
                ...
                if (SANDBOX == true) {
                    $this->logs("RESULT: " . print_r($result, 1));
                }
                ...
                if (($result['CHECKRESULT'] == '[SIGN_GOOD]') &&  ($min <= $result['ORDER_AMOUNT']) && ($max >= $result['ORDER_AMOUNT'])) {

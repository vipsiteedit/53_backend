...
class plugin_shopgeo {
	...
	public function getCities($search = '', $limit = 10, $countries = '') {
        ...
        file_put_contents(__DIR__ . '/test.log', $query_string);
        file_put_contents(__DIR__ . '/test2.log', print_r($data, 1));
	...
	private function getData($query_string = '') {
		$url = 'https://api.siteedit.ru/geo/getCity.php' . $query_string;

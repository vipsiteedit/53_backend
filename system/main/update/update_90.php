...
mysql_query("CREATE TABLE IF NOT EXISTS `shop_feature_group` (
...
mysql_query("CREATE TABLE IF NOT EXISTS `shop_modifications_group` (
`id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
`id_main` int(10) UNSIGNED NOT NULL DEFAULT 1,
...
mysql_query("CREATE TABLE IF NOT EXISTS `shop_feature` (
`id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE IF NOT EXISTS shop_modifications (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE IF NOT EXISTS `shop_group_feature` (
id int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE IF NOT EXISTS shop_feature_value_list (
id int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
id_feature int(10) UNSIGNED NOT NULL,
...
mysql_query("CREATE TABLE IF NOT EXISTS `shop_group_filter` (
id int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
id_group int(10) UNSIGNED NOT NULL,
...
mysql_query("CREATE TABLE IF NOT EXISTS `shop_modifications_img` (
id int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE IF NOT EXISTS `shop_modifications_feature` (
id int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
